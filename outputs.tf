...
output "replica_rds_instance_id" {
  value = [aws_db_instance.read_replica_rds_instance.*.id]
}

output "replicas_rds_instances_address" {
  value = [aws_db_instance.read_replica_rds_instance.*.address]
}
